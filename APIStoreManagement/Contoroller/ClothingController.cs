...
namespace APIStoreManagement.Contoroller
{
    ...
    public class ClothingController : Controller
    {
        ...
        public ClothingController(IClothingRepository clothingRepository, IMapper mapper, IPatternRepository schoolRepository, ISizeRepository sizeRepository, IInventoryRepository inventoryRepository)
        {
        ...
        public IActionResult CreateClothing([FromQuery] int patternId, [FromQuery] int sizeId, [FromBody]ClothingDto clothingCreate)
        {
            ...
            clothingMap.Sizes = _sizeRepository.GetSize(sizeId);
